...
class ExportDataExcel extends ExportData {
	...
	private function generateCell($item) {
		...
		if ($item instanceof ExportDataValue) {
			switch ($item->type)
			{
				case ExportDataValue::TYPE_NUMERIC:
					$type = 'Number';
					$item = $item->value;
					break;

				case ExportDataValue::TYPE_DATE:
					$type = 'DateTime';
				...
				case ExportDataValue::TYPE_STRING:
					$type = 'String';
					$item = $item->value;
					break;
			}
